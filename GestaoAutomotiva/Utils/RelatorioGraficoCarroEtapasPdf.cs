...
{
    public class RelatorioGraficoCarroEtapasPdf : IDocument
    {
        private readonly byte[] _imagemGrafico;

        public RelatorioGraficoCarroEtapasPdf(byte[] imagemGrafico) {
        ...
        public void Compose(IDocumentContainer container) {
            container.Page(page =>
            {
                ...
                page.Content().Column(col =>
                {
                    ...
                    col.Item().PaddingBottom(10).AlignCenter().Text("📊 PLANEJAMENTO DE ATIVIDADES - GRÁFICO DE ETAPAS")
